...
class InverterRegisterGetter(RegisterGetter):
    ...
    REGISTER_LUT = {
        ...
        "v_grid": Def(C.deci, None, IR(1608)),
        "i_grid": Def(C.deci, None, IR(1609)),
        "v_load": Def(C.deci, None, IR(1610)),
        "i_load": Def(C.deci, None, IR(1611)),
        "i_inverter": Def(C.deci, None, IR(1612)),
        "p_ac1": Def(C.uint16, None, IR(1616)),
        "p_inverter_gateway": Def(C.uint16, None, IR(1617)),
        "p_load": Def(C.uint16, None, IR(1618)),
        "p_aio": Def(C.uint16, None, IR(1619)),
        ...
        "e_ac_discharge_today": Def(C.deci, None, IR(1640)),
        "e_ac_discharge_total": Def(C.uint32, C.milli, IR(1641),IR(1642)),
        "e_pv_today": Def(C.deci, None, IR(1643)),
        "e_pv_total": Def(C.uint32, C.milli, IR(1644),IR(1645)),
        "e_ac_charge_today": Def(C.deci, None, IR(1646)),
        "e_ac_charge_total": Def(C.uint32, C.milli, IR(1647),IR(1648)),
        "e_load_today": Def(C.deci, None, IR(1655)),
        "e_load_total": Def(C.uint32, C.milli, IR(1656),IR(1657)),
    ## AIO - 0
        "e_aio0_ac_charge_today": Def(C.deci, None, IR(1649)),
        "e_aio0_ac_charge_total": Def(C.uint32, C.milli, IR(1650),IR(1651)),
        "e_aio0_ac_discharge_today": Def(C.deci, None, IR(1652)),
        "e_aio0_ac_discharge_total": Def(C.uint32, C.milli, IR(1653),IR(1654)),
        "aio0_firmware_version": Def(C.int16, None, IR(1703)),
    ## AIO - 1
        "e_aio1_ac_charge_today": Def(C.deci, None, IR(1705)),
        "e_aio1_ac_charge_total": Def(C.uint32, C.milli, IR(1706),IR(1707)),
        "e_aio1_ac_discharge_today": Def(C.deci, None, IR(1750)),
        "e_aio1_ac_discharge_total": Def(C.uint32, C.milli, IR(1751),IR(1752)),
        "aio1_soc": Def(C.uint16, None, IR(1801)),
        "p_aio1_inverter": Def(C.uint16, None, IR(1816)),
        "aio1_serial_number": Def(C.string, None, IR(1831), IR(1832), IR(1833), IR(1834), IR(1835)),
    ## AIO - 2
        "e_aio2_ac_charge_today": Def(C.deci, None, IR(1708)),
        "e_aio2_ac_charge_total": Def(C.uint32, None, IR(1709),IR(1710)),
        "e_aio2_ac_discharge_today": Def(C.deci, None, IR(1753)),
        "e_aio2_ac_discharge_total": Def(C.uint32, None, IR(1754),IR(1755)),
        "aio2_soc": Def(C.uint16, None, IR(1802)),
        "p_aio2_inverter": Def(C.uint16, None, IR(1817)),
        "aio2_serial_number": Def(C.string, None, IR(1838), IR(1839), IR(1840), IR(1841), IR(1842)),
    ## AIO - 3
        "e_aio3_ac_charge_today": Def(C.deci, None, IR(1711)),
        "e_aio3_ac_charge_total": Def(C.uint32, None, IR(1712),IR(1713)),
        "e_aio3_ac_discharge_today": Def(C.deci, None, IR(1756)),
        "e_aio3_ac_discharge_total": Def(C.uint32, None, IR(1757),IR(1758)),
        "aio3_soc": Def(C.uint16, None, IR(1803)),
        "p_aio3_inverter": Def(C.uint16, None, IR(1818)),
        ...
        "p_inverter_total": Def(C.int16, None, IR(1702)),
        "gateway_state": Def(C.uint16, State, IR(1703)),     #Needs Type

    ## Battery
        "e_battery_charge_today": Def(C.uint16, None, IR(1795)),
        "e_battery_charge_total": Def(C.uint32, None, IR(1796),IR(1797)),
        "e_battery_discharge_today": Def(C.uint16, None, IR(1798)),
        "e_battery_discharge_total": Def(C.uint32, None, IR(1799),IR(1800)),
