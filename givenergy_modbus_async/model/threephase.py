...
class InverterRegisterGetter(RegisterGetter):
    ...
    REGISTER_LUT = {
        ...
        "battery_maintenance_mode": Def(C.uint16, BatteryMaintenance, HR(1124)),    #Needs type
...
ThreePhase = create_model(
    "ThreePhase", __config__=InverterConfig, **InverterRegisterGetter.to_fields()
